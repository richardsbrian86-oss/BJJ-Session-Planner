...
export default function InstructorResetPassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const res = await fetch("/api/instructors/reset-password", {
        method: "POST",
        ...
        <div style={card}>
          {!token ? (
            <div style={{ textAlign: "center" }}>
              ...
              <Link href="/instructor/forgot-password" style={{ color: ACCENT, fontWeight: 600, textDecoration: "none" }}>Request new link</Link>
            </div>
          ) : done ? (
            <div style={{ textAlign: "center" }}>
            ...
            <>
              ...
              <p style={{ color: "#4a5568", fontSize: 14, margin: "0 0 24px" }}>Choose a strong password for your instructor account</p>
