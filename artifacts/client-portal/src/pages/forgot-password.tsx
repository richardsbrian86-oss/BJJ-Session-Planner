          ...
          {sent ? (
            <div style={{ textAlign: "center" }}>
              ...
              <p style={{ color: "#8b9ab3", fontSize: 14, margin: "0 0 24px", lineHeight: 1.6 }}>
                If an account exists for <strong style={{ color: "#eef0f4" }}>{email}</strong>, we've sent a password reset link. It expires in 1 hour.
              </p>
              <Link href="/login" style={{ color: ACCENT, fontWeight: 600, textDecoration: "none", fontSize: 14 }}>Back to sign in</Link>
            </div>
          ) : (
            <>
              <h1 style={{ fontSize: 24, fontWeight: 800, color: "#eef0f4", margin: "0 0 4px", letterSpacing: "-0.02em" }}>Reset your password</h1>
              <p style={{ color: "#4a5568", fontSize: 14, margin: "0 0 24px" }}>Enter your email and we'll send a reset link</p>
              ...
              <div style={{ marginTop: 20, paddingTop: 20, borderTop: "1px solid rgba(255,255,255,0.06)", textAlign: "center", fontSize: 14, color: "#4a5568" }}>
                <Link href="/login" style={{ color: ACCENT, fontWeight: 600, textDecoration: "none" }}>Back to sign in</Link>
              </div>
            </>
          )}
        </div>
